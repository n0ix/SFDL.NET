...
Public Class CollectionViewNameSecureIndicatorConverter
    ...
    Public Function Convert(value As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IValueConverter.Convert
        ...
        If Not IsNothing(_container) AndAlso Not (_container.ContainerFile.Connection.SSLProtocol = Security.Authentication.SslProtocols.None Or _container.ContainerFile.Connection.SSLProtocol = Security.Authentication.SslProtocols.Default) Then
            Return "Secure"
        Else
            Return Binding.DoNothing
        End If
